/*
  El programa no funciona porque no cuenta con memoria compartida a la hora de ejecutar los fork(), por lo que los 
  hijos tienen diferentes direntes direcciones de memoria.
